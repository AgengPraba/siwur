...
<div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-emerald-950 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-lg w-full space-y-8 relative z-10">
        <div class="relative">
            <!-- Enhanced SIWUR Logo and Header -->
            <div class="text-center">
                <div
                    class="relative mx-auto h-28 w-28 flex items-center justify-center rounded-3xl bg-gradient-to-br from-emerald-500 via-teal-600 to-green-700 shadow-2xl transform hover:scale-110 hover:rotate-6 transition-all duration-500 cursor-pointer group">
                    ...
                    <div class="relative z-10 flex flex-col items-center">
                        <x-icon name="o-building-storefront"
                            class="h-10 w-10 text-white group-hover:scale-110 transition-transform duration-300" />
                ...
                <div class="mt-8 space-y-3">
                    ...
                    <div class="flex items-center justify-center space-x-2">
                        <div class="h-px w-12 bg-gradient-to-r from-transparent to-emerald-500"></div>
                        <p class="text-lg text-gray-600 dark:text-gray-300 font-semibold tracking-wide">
                            Sistem Wirausaha Terpadu
                        </p>
                        <div class="h-px w-12 bg-gradient-to-l from-transparent to-emerald-500"></div>
                    </div>
            ...
            <x-card
                class="mt-10 relative backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 shadow-2xl rounded-3xl border border-white/20 dark:border-gray-700/50 overflow-hidden transition-all duration-500 hover:shadow-emerald-500/20 hover:shadow-3xl hover:scale-[1.02] group">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="text-center space-y-2">
                            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">
                                Selamat Datang di SIWUR
                            </h3>
                            <p class="text-gray-600 dark:text-gray-400">
                                Sistem Wirausaha Terpadu untuk Bisnis Modern
                            </p>
                        </div>

                        <!-- Google Login Button -->
                        <a href="{{ route('login.google.redirect') }}"
                            class="w-full flex items-center justify-center px-6 py-4 bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl shadow-lg hover:shadow-xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all duration-300 group">
                            <svg class="w-6 h-6 mr-3 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                                <path fill="#4285F4"
                            ...
                            <span class="text-lg font-medium">Masuk dengan Google</span>
                        </a>

                        <!-- Quick Features Info -->
                        <div class="grid grid-cols-2 gap-3 mt-6">
                            <div class="text-center p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
                                <x-icon name="o-chart-bar" class="w-6 h-6 text-emerald-600 mx-auto mb-2" />
                                <p class="text-xs text-emerald-700 dark:text-emerald-300 font-medium">Laporan Real-time
                                </p>
                            </div>
                            <div class="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                <x-icon name="o-building-storefront" class="w-6 h-6 text-blue-600 mx-auto mb-2" />
                                <p class="text-xs text-blue-700 dark:text-blue-300 font-medium">Multi Store</p>
                            </div>
                            <div class="text-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                <x-icon name="o-cube" class="w-6 h-6 text-purple-600 mx-auto mb-2" />
                                <p class="text-xs text-purple-700 dark:text-purple-300 font-medium">Stok Otomatis</p>
                            </div>
                            <div class="text-center p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                                <x-icon name="o-device-phone-mobile" class="w-6 h-6 text-orange-600 mx-auto mb-2" />
