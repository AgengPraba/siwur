 ...
 <x-breadcrumbs :items="$breadcrumbs" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 pb-4 mt-6">
        <div class="md:col-span-12">
            <x-card title="Lihat PembelianDetail" shadow separator>
               ...
               <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                ...
                <th class="w-44 px-4 py-3 text-left font-semibold bg-gray-100 dark:bg-gray-900"><b>Nomor Pembelian</b></th>
							
                 <td class="px-4 py-3">{{ $pembelian_detail_data->nomor_pembelian }}</td>
					</tr>
               ...
               <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                ...
                <th class="w-44 px-4 py-3 text-left font-semibold bg-gray-100 dark:bg-gray-900"><b>Nama Barang</b></th>
                 ...
                 <td class="px-4 py-3">{{ $pembelian_detail_data->nama_barang }}</td>
					</tr>
               ...
               <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                ...
                <th class="w-44 px-4 py-3 text-left font-semibold bg-gray-100 dark:bg-gray-900"><b>Nama Satuan</b></th>
                 ...
                 <td class="px-4 py-3">{{ $pembelian_detail_data->nama_satuan }}</td>
					</tr>
                ...
                <td class="px-4 py-3">{{ $pembelian_detail_data->harga_satuan }}
                </td>
                ...
                <td class="px-4 py-3">{{ $pembelian_detail_data->jumlah }}
                </td>
                ...
                <td class="px-4 py-3">{{ $pembelian_detail_data->konversi_satuan_terkecil }}
                </td>
                ...
                <td class="px-4 py-3">{{ $pembelian_detail_data->subtotal }}
                </td>
                ...
                <td class="px-4 py-3">{{ $pembelian_detail_data->created_at }}
                </td>
                ...
                <td class="px-4 py-3">{{ $pembelian_detail_data->updated_at }}
                </td>
     ...
     <x-slot:actions>
                    <x-button :href="route('pembelian-detail.index')" wire:navigate class="btn-error text-white btn-sm end"
