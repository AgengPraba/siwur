<?php
$string = "
@section('title','Edit " . str_replace('_', ' ', ucwords($m)) . "')
<div class=\"row-xl\" style=\"padding:10px;\">
    <div class=\"col-md-12\">
        <div class=\"card shadow-sm mb-4\">
            <h5 class=\"card-header\">  Edit Data " . str_replace('_', ' ', ucwords($m)) . " </h5>
            <div class=\"card-body\">
...
$hasil_view_form = createFile($string, "../resources/views/livewire/" . $nama_view_komponen . "/" . $v_komponen_edit);
