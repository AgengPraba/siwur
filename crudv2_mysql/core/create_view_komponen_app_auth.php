            ...
            <div class=\"container-fluid\">
                ...
                <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
                    <ul class=\"navbar-nav ms-auto mb-2 mb-lg-0\">
                        <!-- Menggunakan ms-auto untuk memindahkan menu ke kanan -->
                        <li class=\"nav-item\">
                            <a class=\"nav-link {{ request()->routeIs('login') ? 'active' : '' }}\" wire:navigate href=\"{{ route('login') }}\">Login</a>
                        </li>
                        <li class=\"nav-item\">
                            <a class=\"nav-link {{ request()->routeIs('register') ? 'active' : '' }}\" wire:navigate href=\"{{ route('register') }}\">Register</a>
                        </li>
...
$hasil_view_form = createFile($string, "../resources/views/components/layouts/app_auth.blade.php");
