...
<div class=\"row\"> 
    <div class=\"col-md-12\">
        <div class=\"card\">
            ...
            <div class=\"card-body\">
                <a href=\"{{route('" . $nama_class . ".create')}}\" class=\"btn btn-primary\"  style=\"margin-left:20px;\"><i class=\"fa fa-plus\"></i> Tambah Data</a>
...
$hasil_view_list = createFile($string, $target."/" .$modul_name."/Resources/views/". $nama_class . "/" . $v_list_file);
