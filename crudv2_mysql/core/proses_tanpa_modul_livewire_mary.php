...
$m = ucfirst(toCamelCase($table_name));
$m_file = $m . '.php';
...
$nama_class = strtolower(ucfirst($table_name));
...
if (!file_exists("../app/Livewire/" . $nama_komponen)) {
    ...
    $file = '../routes/web.php';
    include 'create_routing_web_livewire_mary.php';
...
require 'core/create_komponen_mary_index.php';
require 'core/create_view_komponen_mary_index.php';
require 'core/create_komponen_mary_form.php';
require 'core/create_view_komponen_mary_form.php';
require 'core/create_komponen_mary_show.php';
require 'core/create_view_komponen_mary_show.php';
